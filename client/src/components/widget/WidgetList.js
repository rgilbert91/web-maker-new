        ...
        {widgets.map(widget => (
          <section key={widget._id}>
            ...
            {widget.widgetType === "HEADING" && (
              <div>
                {widget.size === "6" && <h1>{widget.text}</h1>}
                {widget.size === "5" && <h2>{widget.text}</h2>}
                {widget.size === "4" && <h3>{widget.text}</h3>}
                {widget.size === "3" && <h4>{widget.text}</h4>}
                {widget.size === "2" && <h5>{widget.text}</h5>}
                {widget.size === "1" && <h6>{widget.text}</h6>}
              </div>
            )}
